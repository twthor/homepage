...
function Projects() {
    return (
        <div>
            ...
            <ProjectItem link={"https://github.com/twthor/homepage"} projectTitle={"This website"} projectDescription={"Made myself a homepage using the react framework. Both to learn some React and to have a resume available at all times 😄."} pictureSrc={websiteCodeImg}/>
        </div>
    );
}
